...
class MainWindow(QWidget):
    ...
    def viewCam(self):
        ...
        while(self.scan<1):
            ...
            for(x,y,w,h) in faces:
                ...
                cv2.imwrite("dataSet/Employee."+str(self.idval)+"."+str(sampleNum)+".jpg",gray[y:y+h,x:x+w])
    ...
    def insertOrUpdate(self):
        ...
        if(str(Name)!="" and str(Age)!="" and str(Gen)!="" and str(Phone)!="" and str(Age).isnumeric() and str(Phone).isnumeric() and (str(Gen).lower() == 'male' or str(Gen).lower()=='female')):
            ...
            cmd3=""
            cmd4=""
            cursor = conn.execute("INSERT INTO employees(employees_id,first_name,age,gender,phone)  Values (NULL, ?, ?, ?, ?)", params)
    ...
    def getImagesWithID(self):
        ...
        for imagepath in imagepaths:
            ...
            faces.append(faceNp)
            IDs.append(ID)
            cv2.imshow("Training From New Employee's Input...",faceNp)
            cv2.waitKey(10)
