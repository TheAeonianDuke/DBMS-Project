...
class Ui_MainWindow(object):
    ...
    def openWindowNewEmployee(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = newemployee.MainWindow(self.window)
    ...
    def openWindowLogin(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = employeelogin.MainWindowLogin(self.window)
        self.thiswindow.close()
        self.window.show()
    ...
    def setupUi(self, MainWindow):
        ...
        self.NewUserBtn.setGeometry(QtCore.QRect(290, 650, 301, 41))
        ...
        self.NewUserBtn.clicked.connect(self.openWindowNewEmployee)
        
        self.ExistingUserBtn_2 = QtWidgets.QPushButton(self.centralwidget)
        self.ExistingUserBtn_2.setGeometry(QtCore.QRect(650, 650, 301, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.NewUserBtn.setText(_translate("MainWindow", "N e w  E m p l o y e e"))
        self.ExistingUserBtn_2.setText(_translate("MainWindow", "E x i s t i n g  E m p l o y e e"))
