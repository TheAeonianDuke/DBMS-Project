...
class Ui_MainWindow(object):
    ...
    def openWindowLoyalty(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = loyaltyui.Ui_MainWindow(self.id)
        self.ui.setupUi(self.window)
        self.window.hide()
        self.window.show()
    def openWindowLastTransaction(self):
        self.window = QtWidgets.QMainWindow()
        self.ui = last_transaction_new.Ui_MainWindow(self.id)
        self.ui.setupUi(self.window)
        self.window.hide()
        self.window.show()
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        tup1=self.fillProfile(self.id)
        tup2=self.fillLoyalty(self.id)
